...
export default function RootLayout() {
  const [systemLoaded, systemError] = useFonts({
    SpaceMono: require('../assets/fonts/SpaceMono-Regular.ttf'),
    ...FontAwesome.font,
  });
  const { loaded: customLoaded, error: customError } = useLoadCustomFonts();

  const loaded = systemLoaded && customLoaded;
  const error = systemError ?? customError;
