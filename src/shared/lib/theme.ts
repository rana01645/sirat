...
// Sukoon Design System — earthy tones, massive whitespace, tranquility
// Replaces NativeWind className-based styling with a centralized theme.
...
export const fonts = {
  ...
  bengaliMedium: 'HindSiliguri-Medium',
  bengaliBold: 'HindSiliguri-Bold',
  mono: 'SpaceMono',
} as const;
